...
steps:
  ...
  juvenile-type-1-diabetes---primary:
    run: juvenile-type-1-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  type-1-diabetes-complication---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: juvenile-type-1-diabetes---primary/output
  ...
  type-1-diabetes-onset---primary:
    run: type-1-diabetes-onset---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  retinopathy-type-1-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: type-1-diabetes-onset---primary/output
  ...
  type-1-diabetes-review---primary:
    run: type-1-diabetes-review---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  type-1-diabetes-gastroparesis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: type-1-diabetes-review---primary/output
  ...
  type-1-diabetes-circulatory---primary:
    run: type-1-diabetes-circulatory---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  type-1-diabetes-manifestation---primary:
    run: type-1-diabetes-manifestation---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: type-1-diabetes-circulatory---primary/output
  dietary-type-1-diabetes---primary:
    run: dietary-type-1-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: type-1-diabetes-manifestation---primary/output
  nephropathy-type-1-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dietary-type-1-diabetes---primary/output
